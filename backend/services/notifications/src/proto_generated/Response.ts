...
export const Response = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Response {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          message.updateJobOfferStatusResponse =
            UpdateJobOfferStatusResponse.decode(reader, reader.uint32());
          break;
        case 19:
          message.getNotificationsResponse = GetNotificationsResponse.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 20:
          message.createNotificationResponse =
            CreateNotificationResponse.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Response {
    ...
    if (
      object.updateJobOfferStatusResponse !== undefined &&
      object.updateJobOfferStatusResponse !== null
    ) {
      message.updateJobOfferStatusResponse =
        UpdateJobOfferStatusResponse.fromJSON(
          object.updateJobOfferStatusResponse,
        );
    } else {
      message.updateJobOfferStatusResponse = undefined;
    }
    if (
      object.getNotificationsResponse !== undefined &&
      object.getNotificationsResponse !== null
    ) {
      message.getNotificationsResponse = GetNotificationsResponse.fromJSON(
        object.getNotificationsResponse,
      );
    } else {
      message.getNotificationsResponse = undefined;
    }
    if (
      object.createNotificationResponse !== undefined &&
      object.createNotificationResponse !== null
    ) {
      message.createNotificationResponse = CreateNotificationResponse.fromJSON(
        object.createNotificationResponse,
      );
    } else {
      message.createNotificationResponse = undefined;
    }
    return message;
  },
  ...
  toJSON(message: Response): unknown {
    ...
    message.getJobCategoriesResponse !== undefined &&
      (obj.getJobCategoriesResponse = message.getJobCategoriesResponse
        ...
        : undefined);
    message.updateJobOfferStatusResponse !== undefined &&
      (obj.updateJobOfferStatusResponse = message.updateJobOfferStatusResponse
        ? UpdateJobOfferStatusResponse.toJSON(
            message.updateJobOfferStatusResponse,
          )
        : undefined);
    message.getNotificationsResponse !== undefined &&
      (obj.getNotificationsResponse = message.getNotificationsResponse
        ? GetNotificationsResponse.toJSON(message.getNotificationsResponse)
        : undefined);
    message.createNotificationResponse !== undefined &&
      (obj.createNotificationResponse = message.createNotificationResponse
        ? CreateNotificationResponse.toJSON(message.createNotificationResponse)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Response>): Response {
    ...
    if (
      ...
      message.updateJobOfferStatusResponse =
        UpdateJobOfferStatusResponse.fromPartial(
          object.updateJobOfferStatusResponse,
        );
    } else {
      message.updateJobOfferStatusResponse = undefined;
    ...
    if (
      ...
      message.getNotificationsResponse = GetNotificationsResponse.fromPartial(
        object.getNotificationsResponse,
      );
    } else {
      message.getNotificationsResponse = undefined;
    ...
    if (
      ...
      message.createNotificationResponse =
        CreateNotificationResponse.fromPartial(
          object.createNotificationResponse,
        );
    } else {
      message.createNotificationResponse = undefined;
